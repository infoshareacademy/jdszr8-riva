...
--)
--to '[selected_directory]\population_age_gender_structure.csv' 	delimiter ','  csv header;
...
--to '[selected_directory]\mean_age_region.csv' 	delimiter ','  csv header;



---Characteristic of cohabitation mode:
--copy(
...
--)
--to '[selected_directory]\cohabitation_mode.csv' 	delimiter ','  csv header;
