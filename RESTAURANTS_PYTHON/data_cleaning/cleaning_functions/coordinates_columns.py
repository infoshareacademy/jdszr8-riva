...
def coordinates_generator(df):
    ...
    coordinates for the district in which the restaurant is located. For the purpose of creating diversified
    locations, the coordinates were varied within the district by using the 'random' module. """
