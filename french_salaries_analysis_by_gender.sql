...
---- Median, interquartile range, MIN and MAX values for the whole country: woman vs. men:
...
--to '[selected_directory]\gender_cities_max_min.csv' 	delimiter ','  csv header;
...
---- Median, MIN, MAX and Q1 and Q3 by position (whole country); woman vs. men:
...
--)
--to '[selected_directory]\gender_position_cities_max_min.csv' 	delimiter ','  csv header;
...
---- Median, MIN, MAX and Q1 and Q3 by age (whole country); woman vs. men:
...
--)
--to '[selected_directory]\gender_age_cities_max_min.csv' 	delimiter ','  csv header;
...
-- map of France divided by regions:
